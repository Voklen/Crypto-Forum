use crate::{custom_types::{Message, MessageForWriting}, *};
	...
	let test_data = vec![
		MessageForWriting {
			...
			signature: ed25519_dalek::Signature::from_bytes(&[
				223, 54, 208, 218, 182, 40, 43, 67, 126, 144, 234, 122, 188, 1, 244,
				145, 178, 155, 128, 132, 104, 202, 56, 75, 182, 52, 30, 189, 85, 187,
				212, 26,209, 88, 143, 230, 22, 220, 153, 232, 13, 149, 168, 68, 222, 167, 36,
				247, 218, 175, 31, 119, 94, 127, 94, 24, 41, 55, 251, 106, 73, 36, 252,
				6
			]).unwrap()
		},
		MessageForWriting {
			...
			message: "hi".to_string(),
			signature: ed25519_dalek::Signature::from_bytes(&[
				104, 155, 246, 24, 42, 222, 149, 101, 11, 135, 170, 97, 217, 184, 226,
				151, 102, 236, 9, 140, 217, 105, 255, 233, 11, 132, 226, 79, 139, 113,
				11, 93, 243, 89, 6, 33, 11, 230, 142, 226, 245, 178, 0, 170, 11, 136, 40, 206,
				195, 176, 90, 130, 72, 155, 216, 124, 43, 224, 142, 28, 143, 95, 81, 3
			]).unwrap()
		},
		MessageForWriting {
			prev_hash: [
			...
			message: "indeed".to_string(),
			signature: ed25519_dalek::Signature::from_bytes(&[
				100, 212, 142, 43, 60, 180, 59, 56, 98, 17, 41, 17, 50, 177, 244, 39,
				194, 143, 255, 15, 188, 42, 152, 248, 157, 237, 255, 64, 36, 132, 15,
				204, 7, 245, 0, 192, 44, 54, 49, 190, 210, 207, 0, 28, 139, 12, 151, 25, 142,
				94, 1, 249, 45, 218, 169, 147, 133, 218, 140, 9, 247, 202, 92, 0
			]).unwrap()
		}
	];
	let expected = vec![
